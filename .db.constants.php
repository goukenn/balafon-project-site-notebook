...
abstract class SiteNoteBookControllerDbConstants{
	...
	const TB_SITE_STATUS = "tnbk_site_status";
	const TB_SITE_SUBSCRIPTIONS = "tnbk_site_subscriptions";
	const TB_SITE_USERS = "tnbk_site_users";
	const TB_SITES = "tnbk_sites";
}
